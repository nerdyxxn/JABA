				...
				<div class="text-box">
					<div class="board-no">
						<input type="text" class="signin-input" id="txt_no" name="txt_no"
							 style="margin-right: 50px; width:75px; text-align: center;"placeholder="글번호5">
					</div>
					<div class="board-title">
						<input type="text" class="signin-input" id="txt_title" name="txt_title" 
						 style="margin-bottom: 10px; margin-left: -18px; width:385px; padding-left: 10px;" placeholder="JABA 결제 방법은 어떤 것이 있나요?">
					</div>
				</div>
					<div class="text-box">
						<div></div>
						...
						<input type="text" class="signin-input" id="txt_main" name="txt_main"
							 style="margin-bottom: 20px; width:385px; padding-left: 10px;" placeholder="관리자"><br>
						</div>
					</div>
					...
					<div class="text-content">
  					...
  					<textarea cols="50" rows="10" style="resize: none; padding: 10px;" placeholder="JABA 결제는 카드 결제만 가능합니다. -관리자 올림"></textarea>
