...
<body>
			...
			<div class="menu_bg">
				<div class="menu_bar">
					...
					<div class="menu_bar_list">
						<a href="./adminClient.jsp">Client</a>
					</div>
					<div class="menu_bar_list">
						<a href="./adminStore.jsp">Biz. Partner</a>
					</div>
					<div class="menu_bar_list">
						<a href="./adminQna.jsp">Q&A</a>
					</div>
				</div>
			</div>
	...
	<section id="home">
		<div class="container">
			<h1>
				<a href="./adminMain.jsp">관리자용 페이지</a>
			</h1>
		</div>
	</section>
	...
	<section id="brands">
		<div class="container">
			...
			<label for="tab1"> <input type="radio" value="CLIENT"
				name="tab" id="tab1" checked="checked" /> <span>STORE</span></label> <label
				for="tab2"> <input type="radio" value="STORE" name="tab"
				id="tab2" /> <span>MENU</span></label> <label for="tab3"> <input
				type="radio" value="BOARD" name="tab" id="tab3" /> <span>BOARD</span></label>
			...
			<div class="resultArea">
				...
				<div data-index="0" class="main_table_store">
					...
					<div class="menu_setting">
						<p style="font-weight: bold;">JABA --> 메뉴 관리</p>
					</div>

					<div class="menu_list">
						<span style="margin-right: 22px; padding-bottom: 8px;">사진</span> <span
							style="margin-right: 53px;">카테고리</span> <span
							style="margin-right: 88px;">이름</span> <span
							style="margin-right: 83px;">가격</span> <span> 메뉴설명</span>
					</div>

					<div class="main_area">
						<span style="margin-right: 17px;">사진</span> <span><select
							name="menu_category"
							style="width: 100px; height: 30px; margin-right: 5px;">
								<option value="">커피</option>
								<option value="30">Non커피</option>
								<option value="31">에이드</option>
								<option value="31">차</option>
						</select></span> <span style="margin-right: 5px;"><input type="text"
							id="menu_coffee" name="menu_coffee"
							style="width: 100px; height: 30px;" placeholder="아메리카노"></span>
						<span style="margin-right: 5px;"><input type="text"
							id="menu_price" name="menu_price"
							style="width: 100px; height: 30px;"
							placeholder="&#8361;&nbsp;4000"></span> <span
							style="margin-right: 5px;"><input type="text"
							id="menu_info" name="menu_info"
							style="width: 120px; height: 30px;" placeholder="에스프레소+물"></span>

						<span><button type="button" class="btnChk"
								id="btnChk_custom" name="btnChk_custom">커스터마이징</button></span> <span><button
								type="button" class="btnChk" id="btnChk_modify"
								name="btnChk_modify">수정</button></span> <span><button
								type="button" class="btnChk" id="btnChk_delete"
								name="btnChk_delete">삭제</button></span>
					</div>

					<div class="add_menu">
						<span><button type="button" class="btnChk" id="btnChk_add"
								name="btnChk_add">메뉴 추가</button></span>
					</div>

					<div class="bottom_btn">
						<span><button type="button" class="btnChk"
								id="bottom_confirm" name="bottom_confirm">확인</button></span> <span><button
								type="button" class="btnChk" id="bottom_cancel"
								name="bottom_cancel">취소</button></span>
					</div>
				</div>
